...
import static com.example.app_music.ApplicationClass.ACTION_NEXT;
import static com.example.app_music.ApplicationClass.ACTION_PLAY;
import static com.example.app_music.ApplicationClass.ACTION_PREV;
import static com.example.app_music.ApplicationClass.CHANNEL_ID_2;
...
public class MainActivity extends AppCompatActivity implements ActionPlaying, ServiceConnection {
    ...
    private void populateFiles() {
        TrackFiles trackFiles = new TrackFiles("Fades",
                "Alan Walker", R.drawable.img1);
        trackFilesArrayList.add(trackFiles);
        TrackFiles trackFiles1 = new TrackFiles("Attention",
                "Charlie Puth",R.drawable.img1);
        trackFilesArrayList.add(trackFiles1);
        TrackFiles trackFiles2 = new TrackFiles("Baarish",
                "Alan Walker2", R.drawable.img1);
        trackFilesArrayList.add(trackFiles2);
        TrackFiles trackFiles3 = new TrackFiles("Fades4",
                "Alan Walker3", R.drawable.img1);
    ...
    public void showNotification(int playPauseBtn){
        ...
        Bitmap picture = BitmapFactory.decodeResource(getResources(),
                trackFilesArrayList.get(position).getThumnail());
        Notification notification = new NotificationCompat.Builder(this,CHANNEL_ID_2)
                .setSmallIcon(trackFilesArrayList.get(position).getThumnail())
